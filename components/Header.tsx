    ...
    <header className="sticky top-0 z-40 w-full overflow-x-clip border-b border-white/10 backdrop-blur supports-[backdrop-filter]:bg-black/40">
      <Container size="lg">
        <div className="flex h-20 items-center justify-between">
          ...
          <nav className="flex items-center gap-7 text-xl sm:text-2xl">
            {/* Social icons */}
            <a href="https://github.com/msiddique12" aria-label="GitHub" className="group inline-flex h-11 w-11 items-center justify-center rounded-md border border-white/15 hover:border-white/30 hover:bg-white/5">
            ...
            <a href="https://linkedin.com/in/muhammad-siddique12" aria-label="LinkedIn" className="group inline-flex h-11 w-11 items-center justify-center rounded-md border border-white/15 hover:border-white/30 hover:bg-white/5">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="text-white/80 group-hover:text-white">
